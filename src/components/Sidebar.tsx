      ...
      >
        ...
        <List>
          <ListItem disablePadding sx={{ color: '#757575' }}>
            <ListItemButton href='/' sx={{ borderRadius: '15px', margin: '15px',backgroundColor: location.pathname === '/' ? '#fff' : 'transparent', '&:hover': { backgroundColor: '#fff', '& .MuiListItemIcon-root, & .MuiListItemText-primary': { color: '#757575' } } }}>
              ...
              <ListItemText primary={"Inicio"} sx={{ color: location.pathname === '/' ? '#757575' : '#fff' }} />
					...
					<ListItem disablePadding sx={{ color: '#757575' }}>
            <ListItemButton href='/perfil' sx={{ borderRadius: '15px', margin: '15px',backgroundColor: location.pathname === '/perfil' ? '#fff' : 'transparent', '&:hover': { backgroundColor: '#fff', '& .MuiListItemIcon-root, & .MuiListItemText-primary': { color: '#757575' } } }} >
              ...
              <ListItemText primary={"Perfil"} sx={{ color: location.pathname === '/perfil' ? '#757575' : '#fff' }} />
					...
					<ListItem disablePadding sx={{ color: '#757575' }}>
            <ListItemButton href='/vista' sx={{ borderRadius: '15px', margin: '15px',backgroundColor: location.pathname === '/vista' ? '#fff' : 'transparent', '&:hover': { backgroundColor: '#fff', '& .MuiListItemIcon-root, & .MuiListItemText-primary': { color: '#757575' } } }}>
